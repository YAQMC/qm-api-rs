...
const SBOX: [[u8; 64]; 8] = [
    ...
    [
        15, 1, 8, 14, 6, 11, 3, 4, 9, 7, 2, 13, 12, 0, 5, 10, 3, 13, 4, 7, 15, 2, 8, 15, 12, 0, 1, 10, 6, 9, 11,
    ...
    [
        ...
        9, 10, 6, 9, 0, 12, 11, 7, 13, 15, 1, 3, 14, 5, 2, 8, 4, 3, 15, 0, 6, 10, 10, 13, 8, 9, 4, 5, 11, 12, 7, 2,
        14,
    ],
    [
...
fn initial_permutation(input: &[u8]) -> (u32, u32) {
    let v0 = (input[0] as u32) | ((input[1] as u32) << 8) | ((input[2] as u32) << 16) | ((input[3] as u32) << 24);
    let v1 = (input[4] as u32) | ((input[5] as u32) << 8) | ((input[6] as u32) << 16) | ((input[7] as u32) << 24);
...
fn inverse_permutation(s0: u32, s1: u32) -> [u8; 8] {
    ...
    let mut data = [0u8; 8];
    data[3] = (bit(s1, 24) << 7) | (bit(s0, 24) << 6) | (bit(s1, 16) << 5) | (bit(s0, 16) << 4) | (bit(s1, 8) << 3)
        | (bit(s0, 8) << 2)
        | (bit(s1, 0) << 1)
        | bit(s0, 0);
    data[2] = (bit(s1, 25) << 7) | (bit(s0, 25) << 6) | (bit(s1, 17) << 5) | (bit(s0, 17) << 4) | (bit(s1, 9) << 3)
        | (bit(s0, 9) << 2)
        | (bit(s1, 1) << 1)
        | bit(s0, 1);
    data[1] = (bit(s1, 26) << 7) | (bit(s0, 26) << 6) | (bit(s1, 18) << 5) | (bit(s0, 18) << 4) | (bit(s1, 10) << 3)
        | (bit(s0, 10) << 2)
        | (bit(s1, 2) << 1)
        | bit(s0, 2);
    data[0] = (bit(s1, 27) << 7) | (bit(s0, 27) << 6) | (bit(s1, 19) << 5) | (bit(s0, 19) << 4) | (bit(s1, 11) << 3)
        | (bit(s0, 11) << 2)
        | (bit(s1, 3) << 1)
        | bit(s0, 3);
    data[7] = (bit(s1, 28) << 7) | (bit(s0, 28) << 6) | (bit(s1, 20) << 5) | (bit(s0, 20) << 4) | (bit(s1, 12) << 3)
        | (bit(s0, 12) << 2)
        | (bit(s1, 4) << 1)
        | bit(s0, 4);
    data[6] = (bit(s1, 29) << 7) | (bit(s0, 29) << 6) | (bit(s1, 21) << 5) | (bit(s0, 21) << 4) | (bit(s1, 13) << 3)
        | (bit(s0, 13) << 2)
        | (bit(s1, 5) << 1)
        | bit(s0, 5);
    data[5] = (bit(s1, 30) << 7) | (bit(s0, 30) << 6) | (bit(s1, 22) << 5) | (bit(s0, 22) << 4) | (bit(s1, 14) << 3)
        | (bit(s0, 14) << 2)
        | (bit(s1, 6) << 1)
        | bit(s0, 6);
    data[4] = (bit(s1, 31) << 7) | (bit(s0, 31) << 6) | (bit(s1, 23) << 5) | (bit(s0, 23) << 4) | (bit(s1, 15) << 3)
        | (bit(s0, 15) << 2)
        | (bit(s1, 7) << 1)
        | bit(s0, 7);
    data
...
const KEY_COMPRESSION: [u32; 48] = [
    13, 16, 10, 23, 0, 4, 2, 27, 14, 5, 20, 9, 22, 18, 11, 3, 25, 7, 15, 6, 26, 19, 12, 1, 40, 51, 30, 36, 46, 54,
...
fn key_schedule(key: &[u8], mode: i32) -> [[u8; 6]; 16] {
    ...
    let v0 = (key[0] as u32) | ((key[1] as u32) << 8) | ((key[2] as u32) << 16) | ((key[3] as u32) << 24);
    let v1 = (key[4] as u32) | ((key[5] as u32) << 8) | ((key[6] as u32) << 16) | ((key[7] as u32) << 24);
